...
private Q_SLOTS:
    ...
    void outputDeviceComboxIndexChangedSlot(int index);
    void inputDeviceComboxIndexChangedSlot(int index);
...
//    MateMixerStreamControl *m_Control;
    ...
    QStringList *m_pInputDeviceNameList;
    QStringList *m_pOutputDeviceNameList;
